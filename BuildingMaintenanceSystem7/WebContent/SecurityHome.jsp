...
<body style="background-image:url(visitors.jpg) ;background-position:center">
  ...
  <h1 style="text-decoration:underline;color:black">Visitor Details</h1>
    ...
    <div class="form-group">
        <label for="approval" class="control-label col-lg-3">Permission</label>
        <div class="col-lg-5">
            <input type="text" class="form-control" id="approval" name = "approval" placeholder="Granted/Denied">
        </div>
    </div>
    <div class="form-group">
